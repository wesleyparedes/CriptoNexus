...
class _DashboardScreenState extends State<DashboardScreen> with TickerProviderStateMixin {
  ...
  backgroundColor: const Color(0xFF1A1A1A), // cinza escuro elegante
  ...
  child: BackdropFilter(
    ...
    child: BottomAppBar(
      color: const Color(0xFF07070C).withOpacity(0.9), // preto fosco
...
class _CalculadoraBottomSheetState extends State<_CalculadoraBottomSheet> {
  ...
  void initState() {
    ...
    // ✅ usa as moedas já carregadas no Dashboard
  ...
  void _abrirSelecao() {
    showModalBottomSheet(
      context: context,
      backgroundColor: const Color(0xFF07070C), // fundo escuro
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return Container(
                      ...
                      child: ListTile(
                        leading:
                            Image.network(c.image, height: 30, width: 30),
                        title: Text(
                          c.name,
                        ...
                        child: Row(
                          children: [
                            if (_selecionada != null)
                              Image.network(_selecionada!.image,
                                  height: 26, width: 26)
                            else
                            ...
                            Text(
                              _selecionada != null
                                  ? "${_selecionada!.symbol.toUpperCase()} - ${_selecionada!.name}"
                                  : "Escolher moeda...",
                              style: const TextStyle(

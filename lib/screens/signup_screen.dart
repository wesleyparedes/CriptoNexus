...
// ======================================================================
// Tela de cadastro do CriptoNexus com Firebase Authentication + Firestore
// - Cria o usuário no Firebase Auth
// - Salva nome completo e e-mail no Firestore
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    const buttonBlue = Color(0xFF2563EB); // mesmo azul do botão "Entrar"
          ...
          child: Center(
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  // 🔹 Mantém a cor original do texto "Criar Conta"
                  const Text(
                    'Criar Conta',
                    style: TextStyle(
                      fontSize: 26,
                  ...
                  // 🔹 Botão "Cadastrar" agora igual ao botão "Entrar"
                  GestureDetector(
  ...
  // ----------------------------------------------------------------------
  // 🔹 Função principal de cadastro (Auth + Firestore)
  // ----------------------------------------------------------------------
